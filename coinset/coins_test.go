...
import (
	...
	"github.com/bitspill/floutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    floutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() floutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value floutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	// should be two outpoints, with 1st one having 0.035FLO value.
	...
	testSimpleCoinTxValue0            = floutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = floutil.NewTxFromBytes(testSimpleCoinTxBytes)
