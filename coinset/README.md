...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitspill/floutil/coinset)
...
```bash
$ go get -u github.com/bitspill/floutil/coinset
```
