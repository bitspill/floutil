...
// Tx returns a wrapped transaction (floutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (floutil.Tx) for all
...
// instead provides easy access to wrapped versions (floutil.Tx) of them.
