...
func TestMerkleBlock3(t *testing.T) {
	...
	blk, err := floutil.NewBlockFromBytes(blockBytes)
	if err != nil {
	...
	err = mBlock.FloEncode(got, wire.ProtocolVersion, wire.LatestEncoding)
	if err != nil {
		t.Errorf("TestMerkleBlock3 FloEncode failed: %v", err)
		return
	}
